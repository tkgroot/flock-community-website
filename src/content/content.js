...
export const contentFlockCommunity = {
  ...
  rows: [
    ...
    },
    {
      ...
      paragraph: `Tijdens sessies georganiseerd door Flock in samenwerking met toonaangevende partners als ING, bol.com en Schiphol kan je gave workshops volgen, of andere inspirerende sessie. Zo laten we onze community en onze klanten iedere dag een stukje groeien.`,
    },
  ],
}
